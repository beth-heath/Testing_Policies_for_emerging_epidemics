  ...
  for(time_step in 1:sim_time){
    ...
    if ((nrow(e_nodes_info)>0)||(nrow(i_nodes_info)>0)) {
      ...
      if (length(pooled_positive) > 10){
        ...
        q_nodes[neg_test] <- 0
      }else if (length(pooled_positive) == 9){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      } else if (length(pooled_positive) == 8){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      }else if (length(pooled_positive) == 7){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      } else if (length(pooled_positive) == 6){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      }else if (length(pooled_positive) == 4){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      }else if (length(pooled_positive) == 3){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      } else if (length(pooled_positive) == 2){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
      ...
      } else if (length(pooled_positive) == 1){
        p_nodes[pooled_positive] <- 0 
        pos_test <- infected_persons[infected_persons %in% pooled_positive]
        neg_test <- pooled_positive[pooled_positive %ni% pos_test]
        q_nodes[neg_test] <- 0
